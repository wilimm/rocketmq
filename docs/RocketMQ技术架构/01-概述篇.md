...
| `store` | 消息存储 | [CommitLog.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/CommitLog.java)、[ConsumeQueue.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/ConsumeQueue.java)、[DefaultMappedFile.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/logfile/DefaultMappedFile.java) |
...
| --- | --- | --- | --- | --- |
| **CommitLog** | 默认 1GB | 变长（消息体+元数据） | 消息头(固定部分) + BODY + TOPIC + PROPERTIES | [CommitLog.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/CommitLog.java) |
...
| **IndexFile** | 约 40MB | 索引条目 20 字节 | `keyHash`(4B) + `phyOffset`(8B) + `timeDiff`(4B) + `prevIndex`(4B) | [IndexFile.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/index/IndexFile.java) |
