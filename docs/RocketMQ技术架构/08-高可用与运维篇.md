...
**核心源码**：
- [BrokerConfig.java](file:///d:/work/github/rocketmq/common/src/main/java/org/apache/rocketmq/common/BrokerConfig.java) - Broker 核心配置类
- [HAService.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/ha/HAService.java) - 主从同步服务
...
**核心源码**：[DLedgerCommitLog.java](file:///d:/work/github/rocketmq/store/src/main/java/org/apache/rocketmq/store/dledger/DLedgerCommitLog.java) - DLedger 模式的 CommitLog 实现
